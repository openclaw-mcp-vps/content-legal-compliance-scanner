    ...
    <main className="min-h-screen bg-[#0d1117] text-[#c9d1d9]">
      ...
      <section className="max-w-3xl mx-auto px-6 pt-24 pb-16 text-center">
        ...
        <p className="text-lg text-[#8b949e] mb-8 max-w-xl mx-auto">
          Paste your blog posts, marketing copy, or website content and get an instant compliance report — medical claims, financial disclaimers, GDPR, and more.
        </p>
        ...
        <div className="mt-10 grid grid-cols-3 gap-4 max-w-lg mx-auto">
          {[
            ['Medical Claims', 'Flags unsubstantiated health statements'],
            ['Financial Advice', 'Detects unlicensed financial guidance'],
            ['GDPR', 'Checks data privacy compliance'],
          ].map(([title, desc]) => (
        ...
        <div className="bg-[#161b22] border border-[#58a6ff] rounded-2xl p-8 text-center shadow-lg">
          ...
          <ul className="text-left space-y-3 mb-8">
            {[
              ...
              'Medical, financial & GDPR checks',
              'Risk score per issue',
      ...
      <section id="faq" className="max-w-2xl mx-auto px-6 pb-24">
        ...
        <div className="space-y-4">
          {[
            [
              'What types of legal issues does it detect?',
              'The scanner checks for unsubstantiated medical claims, unlicensed financial advice, missing GDPR consent language, and other common compliance risks in marketing and editorial content.'
            ],
            [
              'Do I need legal expertise to use this?',
              'No. The tool is designed for content teams and marketers. It highlights risky phrases, explains why they may be problematic, and suggests compliant alternatives in plain English.'
            ],
            [
              'Is my content stored or shared?',
              'Content you paste is processed in real time and never stored on our servers. Your data stays private and is not used for training or shared with third parties.'
            ],
          ].map(([q, a]) => (
      ...
      <footer className="text-center text-[#484f58] text-xs pb-8">
        &copy; {new Date().getFullYear()} Legal Compliance Scanner. Not a substitute for professional legal advice.
      </footer>
    </main>
  )
}
